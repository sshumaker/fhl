...
Many finance systems that are provisioned are also considered a SOX system and are subject to the [SOX Program.](https://about.gitlab.com/handbook/internal-audit/sarbanes-oxley/) 
...
|                   | - No access                    |                   |
| Coupa | | Note: Requestors/buyers will always only get _**Custom User**_ role. Elevated access requires Procurement approval.|
