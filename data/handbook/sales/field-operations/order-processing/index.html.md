...
7. Please note: L&R Support do not have the ability to waive True-Ups, further information on L&R Support responsibilities regarding True-Ups can be found in the [working with sales support handbook page](https://about.gitlab.com/handbook/support/license-and-renewals/workflows/working_with_sales.html#support-responsibilities-regarding-true-up-waiver-requests)
